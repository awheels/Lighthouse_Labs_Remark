...
task "db:populate" do
  ...
  user4 = User.create(username: "Don Burks", password: "12345", email: "don@lighthouselabs.ca")
  user5 = User.create(username: "Khurram Virani", password: "12345", email: "khurram@lighthouselabs.com")
  ...
  c01 = Comment.create(user_id: user1.id, paragraph_id: p21.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c02 = Comment.create(user_id: user2.id, paragraph_id: p31.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c03 = Comment.create(user_id: user3.id, paragraph_id: p41.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c04 = Comment.create(user_id: user4.id, paragraph_id: p22.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c05 = Comment.create(user_id: user5.id, paragraph_id: p23.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c06 = Comment.create(user_id: user4.id, paragraph_id: p33.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c07 = Comment.create(user_id: user3.id, paragraph_id: p42.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c08 = Comment.create(user_id: user2.id, paragraph_id: p52.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c09 = Comment.create(user_id: user3.id, paragraph_id: p51.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c10 = Comment.create(user_id: user5.id, paragraph_id: p41.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c11 = Comment.create(user_id: user1.id, paragraph_id: p42.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c12 = Comment.create(user_id: user1.id, paragraph_id: p23.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c13 = Comment.create(user_id: user2.id, paragraph_id: p21.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c14 = Comment.create(user_id: user3.id, paragraph_id: p32.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c15 = Comment.create(user_id: user2.id, paragraph_id: p41.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c16 = Comment.create(user_id: user4.id, paragraph_id: p21.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c17 = Comment.create(user_id: user2.id, paragraph_id: p53.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c18 = Comment.create(user_id: user1.id, paragraph_id: p22.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c19 = Comment.create(user_id: user3.id, paragraph_id: p31.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c20 = Comment.create(user_id: user5.id, paragraph_id: p42.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c21 = Comment.create(user_id: user2.id, paragraph_id: p51.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
  c22 = Comment.create(user_id: user5.id, paragraph_id: p21.id, content: "<p>#{Faker::Lorem.sentence(1)}</p>")
end